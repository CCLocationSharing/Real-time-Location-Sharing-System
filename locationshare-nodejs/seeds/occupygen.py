...
for i in range(capacities['carpenter']):
	item = {"libID": {"S": "carpenter"}, "tabID": {}, "reservable": {"BOOL": False}, "occupied": {"M": {}}}
	tabidStr = "CH" + str(i)
...
for i in range(capacities['olin']):
	item = {"libID": {"S": "olin"}, "tabID": {}, "reservable": {"BOOL": False}, "occupied": {"M": {}}}
	tabidStr = "OL" + str(i)
	item['tabID'] = {"S": tabidStr}
	packed = {"PutRequest": {"Item": item}}
...
for i in range(capacities['uris']):
	item = {"libID": {"S": "uris"}, "tabID": {}, "reservable": {"BOOL": False}, "occupied": {"M": {}}}
	tabidStr = "UL" + str(i)
	item['tabID'] = {"S": tabidStr}
	packed = {"PutRequest": {"Item": item}}
...
for i in range(capacities['gates']):
	item = {"libID": {"S": "gates"}, "tabID": {}, "reservable": {"BOOL": False}, "occupied": {"M": {}}}
...
for i in range(capacities['mann']):
	item = {"libID": {"S": "mann"}, "tabID": {}, "reservable": {"BOOL": False}, "occupied": {"M": {}}}
	tabidStr = "MANN" + str(i)
	item['tabID'] = {"S": tabidStr}
	packed = {"PutRequest": {"Item": item}}
...
for i in range(capacities['law']):
	item = {"libID": {"S": "law"}, "tabID": {}, "reservable": {"BOOL": False}, "occupied": {"M": {}}}
	tabidStr = "LAW" + str(i)
	item['tabID'] = {"S": tabidStr}
	packed = {"PutRequest": {"Item": item}}

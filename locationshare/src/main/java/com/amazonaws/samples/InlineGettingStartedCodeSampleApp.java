...
public class InlineGettingStartedCodeSampleApp {
     ...
     *      (/Users/maxinyu/.aws/credentials) where the sample code will load the
     *      credentials from.
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            throw new AmazonClientException(
                    ...
                    "location (/Users/maxinyu/.aws/credentials), and is in valid format.",
                    e);
        }
